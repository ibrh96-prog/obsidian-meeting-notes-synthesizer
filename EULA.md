...
This End User License Agreement ("Agreement") is a legal agreement between you ("you" or "the user") and the developer of Meeting Notes Synthesizer ("the Software"). By installing, activating, or using the Software, you agree to the terms of this Agreement. If you do not agree, do not use the Software.
